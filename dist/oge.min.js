var OGE={version:0.7};if(typeof module!=="undefined"&&module.exports)module.exports=OGE;OGE.Direction=function(a,b){this.cos=typeof a!="undefined"?a:0;this.sin=typeof b!="undefined"?b:0};OGE.Direction.prototype.rotate=function(a){a=a*(Math.PI/180);this.cos=Math.cos(Math.acos(this.cos)+a);this.sin=Math.sin(Math.asin(this.sin)+a);return this};OGE.Direction.prototype.clone=function(){return new OGE.Direction(this.cos,this.sin)};OGE.Direction.prototype.serialize=function(){return{cos:this.cos,sin:this.sin}};
OGE.Direction.deserialize=function(a){return new OGE.Direction(a.cos,a.sin)};OGE.Zone=function(a,b){this.x=typeof a!="undefined"?a:0;this.y=typeof b!="undefined"?b:0;this.bodies=[]};OGE.Zone.prototype.addBody=function(a){for(var b=0;b<this.bodies.length;b++)if(this.bodies[b]===a)return;this.bodies.push(a)};OGE.Zone.prototype.removeBody=function(a){for(var b=0;b<this.bodies.length;b++)if(this.bodies[b]===a){this.bodies.splice(b,1);break}};
...
OGE.World.prototype.moveBody=function(a,b,c){var d,e,f;if(arguments.length===1){b=a.direction;c=a.speed}for(var j=0;j<c;j++){d=a.x;e=a.y;this.removeBodyFromZones(a);a.x+=b.cos;a.y+=b.sin;if(a.x>=0&&a.y>=0&&a.x+a.width<=this.width&&a.y+a.height<=this.height){f=this.getBodies(a);for(var i=0;i<f.length;i++){var g=f[i];if(a!==g&&!g.intersects(d,e,a.width,a.height)&&g.intersects(a)){var h=a.collide(g)===true;g=g.collide(a)===true;if(h&&g){a.x=d;a.y=e;this.addBodyToZones(a);if(a.slide&&i>=0)this.slideBody(a,
b);else return}}}this.addBodyToZones(a)}else{a.x=d;a.y=e;break}}};
