var OGE={version:0.7};OGE.merge=function(a,b){for(var c in a)if(Object.prototype.hasOwnProperty.call(a,c))a[c]=b[c];return a};if(typeof module!=="undefined"&&module.exports)module.exports=OGE;OGE.Direction=function(a,b){this.cos=typeof a!="undefined"?a:0;this.sin=typeof b!="undefined"?b:0};OGE.Direction.prototype.rotate=function(a){a=a*(Math.PI/180);this.cos=Math.cos(Math.acos(this.cos)+a);this.sin=Math.sin(Math.asin(this.sin)+a);return this};
OGE.Direction.prototype.clone=function(){return new OGE.Direction(this.cos,this.sin)};OGE.Direction.prototype.serialize=function(){return{cos:this.cos,sin:this.sin}};OGE.Direction.deserialize=function(a){var b=new OGE.Direction(a.cos,a.sin);return OGE.merge(b,a)};OGE.Zone=function(a,b){this.x=typeof a!="undefined"?a:0;this.y=typeof b!="undefined"?b:0;this.bodies=[]};OGE.Zone.prototype.addBody=function(a){for(var b=0;b<this.bodies.length;b++)if(this.bodies[b]===a)return;this.bodies.push(a)};
