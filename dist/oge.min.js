...
OGE.World.prototype.moveBody=function(a,b,c){var d,e,f;if(arguments.length===1){b=a.direction;c=a.speed}for(var j=0;j<c;j++){d=a.x;e=a.y;this.removeBodyFromZones(a);a.x+=b.cos;a.y+=b.sin;f=this.getBodies(a);for(var i=0;i<f.length;i++){var g=f[i];if(a!==g&&!g.intersects(d,e,a.width,a.height)&&g.intersects(a)){var h=a.collide(g)===true;g=g.collide(a)===true;if(h&&g){a.x=d;a.y=e;this.addBodyToZones(a);if(a.slide&&i>=0)this.slideBody(a,b);else return}}}this.addBodyToZones(a)}};
